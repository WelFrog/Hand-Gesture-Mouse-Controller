# Hand-Gesture-Mouse-Controller (基于 MediaPipe 与高性能 C++ DLL)

本项目是一个高性能的桌面鼠标控制系统，通过摄像头实时捕捉手部关键点，结合先进的平滑和加速算法，实现低延迟、精确的隔空鼠标操作。本系统特别优化了性能瓶颈，采用自定义编译的 C++ DLL 进行鼠标底层控制，以确保流畅稳定的用户体验。
